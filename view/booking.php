                ...
                <div role="tabpanel">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="index.php?act=booking" aria-controls="booking_info" role="tab" data-toggle="tab"><i>1</i><span>Thông tin đặt phòng</span></a>
                        </li>
                        <li role="presentation">
                            <a href="index.php?act=ttcanhan&idphong=" .$id aria-controls="personal_info" role="tab" data-toggle="tab"><i>2</i><span>Thông tin cá nhân</span></a>
                        </li>
                        <li role="presentation">
                            <a href="#payment_info" aria-controls="payment_info" role="tab" data-toggle="tab"><i>3</i><span>Thanh toán </span></a>
                        </li>
                        <li role="presentation">
                            <a href="#booking_done" aria-controls="booking_done" role="tab" data-toggle="tab"><i>4</i><span>Đặt phòng xong</span></a>
                        </li>
                    </ul>
                    <?php
                    extract($phong);
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="section_title clearfix margin-bottom-5">
                                                        <h5 class="floatleft"><?= $name ?><span class="price floatright margin-left-15">(<?= $giaPhong . "đ" ?><sup class="day">/night</sup>)</span></h5>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table table-bordered">
                                                                    <tr class="room_table">
                                                                        ...
                                                                        <td class=""><span class="imp_table_text"><?= $giaPhong . "đ" ?></span> <br> </td>
                                                                        <td class=""> 1<br>night</td>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="booking_next_btn padding-top-30 margin-top-20 clearfix border-top-whitesmoke">
                                                <a href="index.php?act=ttcanhan&idphong=<?= $phong['id'] ?>" class="btn btn-warning btn-sm floatright">Next</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
